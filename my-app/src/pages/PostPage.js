...
import likeimage from '../image/like.png'; // 이미지 파일 가져오기
import dislikeimage from '../image/dislike.png';
import commentsend from '../image/comment.png';
    ...
    return (
      <div className="postpage-container">
        ...
        <div className="post-container">
          ...
          <p>{post.content}</p>
          {post.imageUrl && (
            <img src={post.imageUrl} alt="Post" className="postpage-post-image" />
          )}<br></br>
        </div>
        <div className="comment-container">
          <div className='comment-grp'>
            ...
            ></textarea>
            <button onClick={handleAddComment}><img src={commentsend} alt='댓글 추가' class="comment-resized-image" /></button>
          </div>
          <div>
            {comments.map((c) => (
              <div key={c.id} className="comment">
                <img src={c.user.profileImage} className="comment-profile-image" />
                {editingCommentId === c.id ? (
                  ...
                  <div>
                    <p className='comment-content'> 작성자 : {c.user.nickname}  </p>
                    <p>{c.content}</p>
                    <p>{post.createdAt}</p>
                    <div className="comment-buttons">
    ...
    return (
      <div className="postpage-container">
        ...
        <div className="post-container">
          ...
          <button onClick={handleLike}><img src={likeimage} alt="좋아요 버튼" class="post-resized-image" /></button>
          {post.likes}
          <button onClick={handleDisLike}><img src={dislikeimage} alt="싫어요 버튼" class="post-resized-image2" /></button>
          {post.dislikes}
        </div>
        ...
        <div className="comment-container">
          ...
          <div>
            {comments.map((c) => (
              <div key={c.id} className="comment">
                <img src={c.user.profileImage} alt="Profile" className="comment-profile-image" />
                {editingCommentId === c.id ? (
                  <div>
                    <textarea
                      value={editingCommentContent}
      ...
      <div className="postpage-container">
        ...
        <div className="post-container">
          <div className='post-title'>
            ...
            <div className='button-grp'>
              <button onClick={handleUpdatePost}>수정</button>
              <button onClick={handleUpdatePost}>삭제</button>
            </div>
          </div>
